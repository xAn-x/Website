  ...
  return (
    <div className={'block md:flex rounded-md m-2 bg-black text-mono text-white pb-5'}>
      ...
      <div className="about flex-1 mx-2">
        ...
        <p className='text-[1.1rem] p-2 text-justify'>
          In addition to my focus on data-driven technologies, I have a solid background in core computer science subjects. My expertise spans Operating Systems, Database Management Systems (DBMS), MySQL, and Computer Networks (CN). This strong theoretical foundation supports my practical work, where I have successfully tackled over 850 problems on LeetCode, showcasing my problem-solving capabilities. I am proficient in programming languages such as C++, Java, Python, and JavaScript, which I leverage to bring complex ideas to life.
        </p>
        <p className='text-[1.1rem] p-2 text-justify'>
