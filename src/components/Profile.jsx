    ...
    <div className={'block md:flex rounded-md m-2 bg-black text-mono text-white pb-5'}>
      ...
      <div className="about flex-1 mx-2">
        ...
        <p className='text-[1.1rem] p-2 text-justify'>
          ...
          I’ve successfully tackled over 850 problems on LeetCode, showcasing my problem-solving capabilities.
        ...
        <a href='https://drive.google.com/file/d/1xqOKWINQVTweBdk0VkJe_Ir6vtIBa8j0/view?usp=drive_link'  target='_blank' className={'inline-block text-center border border-blue-600 text-[1.1rem] p-3 w-[100px] hover:bg-blue-600 hover:border-white rounded-md my-2'}>
            Resume
        </a>
      </div>
    </div>
